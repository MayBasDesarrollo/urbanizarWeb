    ...
    <div class="content">
        <div class="animated fadeIn">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        <div class="stat-text"><span class="count">{{ $propiedades }}</span></div>
                            ...
                            <div class="stat-widget-five">
                                ...
                                <div class="stat-content">
                                    <div class="text-left dib">
                                        ...
                                        <div class="stat-heading">Mensajes</div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="alert alert-success" role="alert">
                <strong> Urbanizar te da la Bienvenida </strong> al nuevo portal de administración.
            </div>
        </div>
    </div>
